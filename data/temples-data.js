export const templesData = [
  {
    ...
    description:
      "A magnificent example of Chola architecture with a 66m tall vimana",
    detailedDescription:
    ...
    festivals: [
      {
        ...
        description:
          "Grand celebration with night-long prayers and cultural programs",
      },
      {
        name: "Chola Festival",
        period: "January",
  ...
  },
  {
    ...
    detailedDescription:
      "The Meenakshi Amman Temple is a historic Hindu temple located on the southern bank of the Vaigai River in Madurai, Tamil Nadu. It is dedicated to Meenakshi, a form of Parvati, and her consort, Sundareshwarar, a form of Shiva. The temple forms the heart and lifeline of the 2,500-year-old city of Madurai and is a significant symbol for the Tamil people.",
    history:
      "The temple has ancient origins, but the present structure was built between the 12th and 17th centuries by the Pandyan Dynasty and later rulers. It has been mentioned in various Tamil texts and has been a center of worship for over 2000 years. The temple complex covers 14 acres and contains 14 gopurams (gateway towers), ranging from 45-50m in height.",
    image:
      "https://plus.unsplash.com/premium_photo-1697729444936-8c6a6f643312?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    gallery: [
    ...
    festivals: [
      {
        ...
        period: "April/May",
        description:
          "10-day festival celebrating the divine marriage of Meenakshi and Sundareshwarar",
      },
      {
        name: "Float Festival",
        period: "January/February",
        description:
          "Beautiful festival where deities are taken on decorated floats in the temple tank",
      },
    ],
  },
  {
    ...
    festivals: [
      {
        ...
        period: "February/March",
        description:
          "Most important festival with millions of devotees visiting",
      },
      {
        name: "Kartik Purnima",
        period: "November",
        description:
          "Sacred festival celebrated with special prayers and light decorations",
      },
    ],
  },
  {
    ...
    festivals: [
      {
        ...
        period: "June/July",
        description:
          "World-famous chariot festival attracting millions of devotees",
      },
      {
        name: "Snana Yatra",
        period: "May/June",
    ...
    festivals: [
      {
        ...
        period: "April/May",
        description:
          "Annual opening ceremony of the temple after winter closure",
      },
      {
        name: "Maha Shivaratri",
        period: "February/March",
        description:
          "Special celebrations despite winter closure, prayers offered at Ukhimath",
      },
    ],
  },
  {
    ...
    festivals: [
      {
        ...
        description:
          "9-day annual festival with elaborate processions and ceremonies",
      },
      {
        name: "Vaikunta Ekadashi",
        period: "December/January",
        description:
          "Most sacred festival when the golden Vaikunta Dwaram opens",
      },
    ],
  },
];
